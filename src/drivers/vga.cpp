...
VideoGraphicsArray::VideoGraphicsArray() :
    ...
    attributesControllerIndexPort(0x3C0),
    attributesControllerReadPort(0x3C1),
    attributesControllerWritePort(0x3C0),
    attributesControllerResetPort(0x3DA)
{
}
...
void VideoGraphicsArray::WriteRegisters(uint8_t *registers)
{
    ...
    {
        attributesControllerResetPort.Read();
        attributesControllerIndexPort.Write(i);
        attributesControllerWritePort.Write(*(registers++));
    }

    attributesControllerResetPort.Read();
    attributesControllerWritePort.Write(0x20);
}

bool VideoGraphicsArray::SupportsMode(int width, int height, int colordepth)
{
    return width == 320 && height == 200 && colordepth == 8;
}

bool VideoGraphicsArray::SetMode(int width, int height, int colordepth)
{
...
uint8_t VideoGraphicsArray::GetColorIndex(uint8_t r, uint8_t g, uint8_t b)
{
    ...
    if(r == 0xA8 && g == 0x55 && b == 0x00) return 0x06; // brown
    if(r == 0xA8 && g == 0xA8 && b == 0xA8) return 0x07; // grey
