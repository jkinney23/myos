#ifndef MYOS__HARDWARECOMMUNICATION__PCI_H
#define MYOS__HARDWARECOMMUNICATION__PCI_H
...
namespace myos
{
    namespace hardwarecommunication
    {
        ...
        public:
            ...
            myos::common::uint32_t Read(myos::common::uint16_t bus, myos::common::uint16_t device,
                    myos::common::uint16_t function, myos::common::uint32_t registeroffset);
            ...
            BaseAddressRegister GetBaseAddressRegister(myos::common::uint16_t bus, myos::common::uint16_t device,
